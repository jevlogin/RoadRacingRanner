...
namespace JevLogin
{
    internal sealed class ButtonFlareBehaviour : MonoBehaviour
    {
        [SerializeField] private float _interval;

        [Space, SerializeField] private Image _highlightImage;

        [Space, SerializeField] private float _upFadeDuration;
